...
function showcase_front_page_genesis_meta() {
	...
	if ( is_active_sidebar( 'front-page-intro' ) || is_active_sidebar( 'front-page-hero' ) || is_active_sidebar( 'front-page-1' ) || is_active_sidebar( 'front-page-2' ) || is_active_sidebar( 'front-page-3' ) || is_active_sidebar( 'front-page-4') ) {
